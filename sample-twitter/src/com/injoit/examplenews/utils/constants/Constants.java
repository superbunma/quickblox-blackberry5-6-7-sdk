...
package com.injoit.examplenews.utils.constants;

public interface Constants 
{
    public static final int MAIN_BACKGROUND_COLOR = 0x2f2f2f; 
    public static final int WHITE_BACKGROUND_COLOR = 0xffffff;
    
    public static final String CALENDAR_NO_EVENTS_ALERT = "There are no DSTV events on this date!";

    public static final String NEWS_SCREEN_TITLE          = "News";
    
    public static final String DEFAULT_SUPPORT_EMAIL_ADDRESS = "vladimir.slatvinskiy@injoit.com";
    public static final String SUPPORT_TITLE                 = "Email logs";
    public static final String SUPPORT_PROMPT                = "Please enter Email address";
    
    public static final String CHECKIN_PROMPT                = "Please enter text message";
    
    public static final String ALERT_TWITTER_LOGIN = "For login and post messages to Twitter, please go to TV item, which you would like to post and select Share -> Twitter.";
    public static final String RATE_POPUP_RATE    = "Rate";
    
    public final static String[] CHECKIN_SETTINGS = new String[]{"On", "Off"};
    public final static String[] TWITTER_SETTINGS = new String[]{"Login", "Logout" };
    public final static String[] FACEBOOK_SETTINGS = new String[]{"Login", "Logout" };
    public final static String[] PUSH_NOTIFICARIONS_SETTINGS = new String[]{"On", "Off"};
