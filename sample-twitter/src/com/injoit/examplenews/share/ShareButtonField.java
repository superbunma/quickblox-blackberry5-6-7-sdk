...
//  @ File Name : ShareButtonField.java
//  @ Date : 10/06/2012
...
public class ShareButtonField extends Field implements ListStyleAbstract
{
    ...
    public static int SHARE_TWITTER  = 0;
    public static int SHARE_SOMETHING  = 1;
    public static int SHARE_HEADER   = 2;
    ...
    public ShareButtonField(String text, int context)
    {
        ...
        switch(context)
        {
            case 0: //SHARE_TWITTER:
            {
                picture = Utils.getBitmap("share_twitter.png");
                break;
            }
            case 1: //SHARE_SOMETHING:
            {
                picture = Utils.getBitmap("something.png");
                break;
            }
            case 2: //SHARE_HEADER
            {
