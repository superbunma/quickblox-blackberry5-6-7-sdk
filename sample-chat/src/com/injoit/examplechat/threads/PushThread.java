...
public class PushThread extends Thread
{
        ...
        public PushThread(String _conn, ChatManager _midlet)
        {
                conn = _conn;
                midlet = _midlet;
        }
        public PushThread(ChatManager _midlet)
        {
                register = true;
                midlet = _midlet;
        }
        ...
        {              
                try
                {
                        ...
                        else //show the arrived sms
                        {
                                ...
                                midlet.display.showAlert("sms");
                        }
                }
                catch (Exception e)
                {
                        midlet.getGuiOnlineMenu();//("no phone"
                        return;
                }
        }
}
