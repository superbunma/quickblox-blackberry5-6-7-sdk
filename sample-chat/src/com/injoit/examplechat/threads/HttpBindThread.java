...
import com.injoit.examplechat.jmc.StanzaReader;
...
public class HttpBindThread extends Thread implements IWriterThread{
        ...
        private ChatEventListener eventsListener;
         ...
         * Constructor
         */
        public HttpBindThread(StanzaReader _stanzaReader, ChatEventListener events) {
