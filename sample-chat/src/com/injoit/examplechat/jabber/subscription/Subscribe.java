 ...
 */
package com.injoit.examplechat.jabber.subscription;
...
public class Subscribe 
{
    ...
    */
    public static void setNewRosterItem(Jid _jid, boolean isNew) 
    {
        ...
        if (isNew) res += "<presence from=\'" + Datas.jid.getFullJid() + "\' to=\'" + _jid.getFullJid() + "\' type='subscribe'/>";
    ...
    * @param _jid
    */
    public static void renameRosterItem(Jid _jid) 
    {
        String res =  "<iq from=\'"+ Datas.jid.getFullJid() + "\' type=\'set\' id=\'roster_rename\'><query xmlns=\'jabber:iq:roster\'><item name=\'" + _jid.getNick() + "\' jid=\'"+_jid.getFullJid()+"\' subscription=\'both\'></item></query></iq>";
        Datas.writerThread.write(res);
    }
